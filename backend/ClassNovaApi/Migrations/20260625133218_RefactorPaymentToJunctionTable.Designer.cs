...
namespace ClassNovaApi.Migrations
{
    ...
    [Migration("20260625133218_RefactorPaymentToJunctionTable")]
    partial class RefactorPaymentToJunctionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassNovaApi.Models.TeacherAttendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTime?>("CheckInAttemptedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("check_in_attempted_at");
                    ...
                    b.Property<DateTime?>("OriginalCheckInTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("original_check_in_time");

                    b.Property<DateTime?>("OriginalCheckOutTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("original_check_out_time");
                    ...
                    b.HasIndex("ModifiedById")
                        .HasDatabaseName("ix_teacher_attendances_modified_by_id");

                    b.HasIndex("TeacherId")
                        .HasDatabaseName("ix_teacher_attendances_teacher_id");

                    b.HasIndex("TenantId", "Date")
                        .HasDatabaseName("ix_teacher_attendances_tenant_id_date");

                    b.HasIndex("TenantId", "TeacherId", "Date")
                        .IsUnique()
                        .HasDatabaseName("ix_teacher_attendances_tenant_id_teacher_id_date");
            ...
            modelBuilder.Entity("ClassNovaApi.Models.TeacherAttendance", b =>
                {
                    b.HasOne("ClassNovaApi.Models.User", "ModifiedBy")
                        .WithMany()
                        .HasForeignKey("ModifiedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_teacher_attendances_users_modified_by_id");
                    ...
                    b.HasOne("ClassNovaApi.Models.Teacher", "Teacher")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_teacher_attendances_teachers_teacher_id");
                    ...
                    b.HasOne("ClassNovaApi.Models.Tenant", "Tenant")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_teacher_attendances_tenants_tenant_id");
